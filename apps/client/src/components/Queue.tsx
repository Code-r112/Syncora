      ...
      <div className="space-y-1">
        {audioSources.length > 0 ? (
          ...
          <motion.div
            ...
            className="w-full text-center select-none flex flex-col items-center justify-center py-12"
          >
            ...
            {isInitingSystem ? (
              ...
              <>
                ...
                <p className="text-sm text-neutral-400 max-w-[250px]">
                  {canMutate
                    ? "Select a track below to get the party started!"
                    : "Wait for an admin to add tracks to the session."}
                </p>
              </>
            )}
          </motion.div>
