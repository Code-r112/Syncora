      ...
      <AnimatePresence>
        {isUserScrolling && newMessageCount > 0 && (
          <motion.button
            ...
            className="absolute left-1/2 -translate-x-1/2 z-20 flex items-center gap-1 px-3 py-1.5 bg-purple-800 hover:bg-purple-700 text-white text-xs font-medium rounded-full shadow-lg shadow-purple-900/40 transition-colors duration-500"
